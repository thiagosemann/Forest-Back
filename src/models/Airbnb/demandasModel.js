...
const getAllDemandas = async (empresaId) => {
  ...
  let query = `SELECT d.*, a.nome AS apartamento_nome, a.endereco AS apartamento_endereco, a.senha_porta AS apartamento_senha_porta, a.is_active AS apartamento_ativo
     FROM demandas d
